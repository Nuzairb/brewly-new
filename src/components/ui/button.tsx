  ...
  "inline-flex items-center justify-center whitespace-nowrap transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none shrink-0 outline-none",
  {
    variants: {
      variant: {
        ...
        aiTabActive: "bg-transparent text-[#00674E] font-lato font-medium text-[14px] pb-[9px]",
        aiTabInactive: "bg-transparent text-[#787777] font-lato font-medium text-[14px] pb-[9px]",
