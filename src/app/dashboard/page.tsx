      ...
      <div className="w-full p-6 box-border">
        ...
        <div className="w-full grid grid-cols-[2fr_1fr] gap-6 mb-6">
          ...
          <div className="w-full h-[556px] grid grid-cols-1 gap-6">
            ...
            <div className="w-full h-[267px] bg-white border border-gray-200 rounded-xl p-6 box-border">
              {/* Header */}
            ...
            <div className="w-full h-[265px] p-6 box-border bg-white border border-gray-200 rounded-xl">
              {/* Header */}
